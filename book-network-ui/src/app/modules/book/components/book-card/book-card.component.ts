...
export class BookCardComponent {
  ...
  get bookCover(): string | undefined {
    ...
    let d: Date = new Date();
    return 'https://picsum.photos/200/300?t=' + d.getTime();// a random image (add Date Time to url to get new request for each book card)
  }
  ...
  @Output()
  borrow: EventEmitter<BookResponse> = new EventEmitter<BookResponse>();
